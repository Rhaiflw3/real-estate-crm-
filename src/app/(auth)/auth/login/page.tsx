  ...
  return (
    <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      <div className="bg-slate-900 py-8 px-4 shadow-2xl sm:rounded-2xl sm:px-10 border border-slate-800">
        ...
        {message && (
          <div className="mb-6 bg-emerald-900/40 border border-emerald-500/30 text-emerald-200 px-4 py-3 rounded-lg text-sm flex items-center">
        ...
        <div className="mt-8">
          ...
          <div className="mt-6">
            <button
              ...
              className="w-full flex justify-center py-2.5 px-4 border border-slate-700 rounded-lg shadow-sm bg-slate-800 text-sm font-medium text-slate-400/50 hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 focus:ring-offset-slate-900 transition-all cursor-not-allowed"
              disabled
              title="Google sign-in not configured yet"
            >
              <svg className="w-5 h-5 mr-2.5 opacity-50" viewBox="0 0 24 24" fill="currentColor">
